## ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Project 3: Modeling Housing Data 
...
| --- | --- | --- |
| UP3 Notebook | Housing - Linreg AND Knn | [Here](./Unit_Project3.ipynb) |

---

## Project Objective

In this project, you'll build a linear regression model and a KNN model using guided prompts. You will be exposed to model validation using the train/test split and K-Fold methods in order to fit three different models on sample Boston housing data.
